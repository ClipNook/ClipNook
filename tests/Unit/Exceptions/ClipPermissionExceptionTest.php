...
test('creates exception for submit permission', function (): void {
...
test('creates exception for edit permission', function (): void {
...
test('creates exception for delete permission', function (): void {
...
test('creates exception for moderate permission', function (): void {
