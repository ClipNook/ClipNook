...
it('allows verified users to create comments', function () {
...
it('denies users from deleting others comments', function () {
    $user       = User::factory()->create();
...
it('allows users to update their own comments within 15 minutes', function () {
    $user    = User::factory()->create();
...
it('denies users from updating their own comments after 15 minutes', function () {
    $user    = User::factory()->create();
    $comment = ClipComment::factory()->create([
        'user_id'    => $user->id,
...
it('allows users to view non-deleted comments', function () {
    $user    = User::factory()->create();
...
it('allows users to view their own deleted comments', function () {
    $user    = User::factory()->create();
    $comment = ClipComment::factory()->create([
        'user_id'    => $user->id,
        'is_deleted' => true,
...
it('denies users from viewing others deleted comments', function () {
    $user       = User::factory()->create();
    $otherUser  = User::factory()->create();
    $comment    = ClipComment::factory()->create([
