        ...
        <div class="max-w-md w-full space-y-8">
            ...
            >
                <div class="flex items-center justify-center gap-2">
                    <i class="fa-solid fa-video text-purple-400 text-3xl"></i>
                </div>
            </x-ui.hero-section>

            <!-- Login Card -->
            <div class="bg-neutral-900 rounded-lg border border-neutral-800 shadow-2xl">
                <div class="p-8">
                    <form method="POST" action="{{ route('auth.twitch.login') }}" class="space-y-6">
                        ...
                        <!-- Features List -->
                        <div class="space-y-4">
                            <div class="flex items-center gap-4 p-3 bg-neutral-800/50 rounded-lg border border-neutral-700/50">
                                ...
                                <span class="text-neutral-200 font-medium">{{ __('auth.feature_secure') }}</span>
                            </div>
                            <div class="flex items-center gap-4 p-3 bg-neutral-800/50 rounded-lg border border-neutral-700/50">
                                ...
                                <span class="text-neutral-200 font-medium">{{ __('auth.feature_authentication') }}</span>
                            </div>
                            <div class="flex items-center gap-4 p-3 bg-neutral-800/50 rounded-lg border border-neutral-700/50">
                                <div class="w-8 h-8 bg-neutral-600/20 rounded-full flex items-center justify-center flex-shrink-0">
                                    <i class="fa-solid fa-shield-halved text-neutral-400 text-sm"></i>
                                </div>
                                <span class="text-neutral-200 font-medium">{{ __('auth.feature_privacy') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="text-center pt-4 border-t border-neutral-800">
                            <p class="text-sm text-neutral-500 leading-relaxed">
                                {!! __('auth.privacy_notice', [
                                    'terms' => '<a href="#" class="text-purple-400 hover:text-purple-300 underline transition-colors">Terms of Service</a>',
                                    'privacy' => '<a href="#" class="text-purple-400 hover:text-purple-300 underline transition-colors">Privacy Policy</a>'
                                ]) !!}
                            </p>
                        </div>
                    </form>
