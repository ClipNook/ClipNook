<div>
    ...
    <div class="mb-6">
        ...
        @if($search)
            <div class="mt-4 flex items-center gap-2">
                ...
                <span class="inline-flex items-center gap-2 px-3 py-1.5 bg-zinc-800 border border-zinc-700 rounded-md text-sm text-zinc-300">
                    <i class="fa-solid fa-magnifying-glass text-xs text-zinc-500"></i>
                    {{ $search }}
                    <button wire:click="$set('search', '')" class="text-zinc-400 hover:text-white transition-colors ml-1">
    ...
    @else
        ...
        <div class="text-center py-16">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-lg bg-zinc-800 border border-zinc-700 mb-4">
