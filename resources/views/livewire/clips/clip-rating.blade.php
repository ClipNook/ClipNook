    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            <button 
                ...
                class="flex items-center gap-2 px-4 py-2 rounded-md transition-colors {{ $userVote?->value === 'upvote' ? 'bg-purple-600 text-white' : 'bg-gray-800 hover:bg-gray-700 text-white' }}"
            >
            ...
            <button 
                ...
                class="flex items-center gap-2 px-4 py-2 rounded-md transition-colors {{ $userVote?->value === 'downvote' ? 'bg-red-600 text-white' : 'bg-gray-800 hover:bg-gray-700 text-white' }}"
            >
