    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <button
                ...
                class="group flex items-center gap-2 px-4 py-2.5 rounded-md transition-all {{ $userVote?->value === 'upvote' ? 'bg-zinc-700 text-white border border-zinc-600' : 'bg-zinc-800 hover:bg-zinc-700 text-zinc-400 hover:text-white border border-zinc-700' }}"
            ...
            <button
                ...
                class="group flex items-center gap-2 px-4 py-2.5 rounded-md transition-all {{ $userVote?->value === 'downvote' ? 'bg-zinc-700 text-white border border-zinc-600' : 'bg-zinc-800 hover:bg-zinc-700 text-zinc-400 hover:text-white border border-zinc-700' }}"
