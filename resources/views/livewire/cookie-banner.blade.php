        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div class="flex-1">
                <h3 class="text-lg font-semibold text-gray-100 mb-2">
                    <i class="fas fa-cookie-bite mr-2 text-purple-400" aria-hidden="true"></i>
                    {{ __('cookies.title') }}
                </h3>
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                <button wire:click="accept"
                    class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-gray-950"
